...
var SignIn = require("./user/signing");

},{"./user/signing":210}],208:[function(require,module,exports){
    ...
    render: function () {
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement('input', { type: 'button', value: 'Sign in', onClick: this.signIn })
            )
        );
    }
});
...
},{"react":159,"socket.io-client":160}],210:[function(require,module,exports){
var React = require('react');
...
var Signing = React.createClass({
    ...
    render: function () {
        return React.createElement(
            'div',
            null,
            React.createElement(Button, { text: 'Sign up' }),
            React.createElement(Button, { className: 'button-signin', text: 'Sign in', onClick: this.onClickSignIn }),
            this.state.showSignIn ? React.createElement(SignIn, { className: 'dropdown' }) : null
        );
    }
});

ReactDOM.render(React.createElement(Signing, null), document.getElementById('page-header-signing'));

},{"./button":208,"./sign-in":209,"react":159,"react-dom":3}]},{},[207]);
